...
import com.example.hotfix.tinkerutils.MyLogImp;
import com.example.hotfix.tinkerutils.TinkerManager;
...
@DefaultLifeCycle(application = "com.example.hotfix.MyApplication",// application类名。只能用字符串，这个MyApplication文件是不存在的，但可以在AndroidManifest.xml的application标签上使用（name）
